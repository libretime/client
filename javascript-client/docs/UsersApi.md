...
let apiInstance = new LibreTimeApi.UsersApi();
let user = new LibreTimeApi.User(); // User | 
apiInstance.usersCreate(user, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.usersDestroy(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new LibreTimeApi.UsersApi();
apiInstance.usersList((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> User usersPartialUpdate(id, opts)
...
let id = 56; // Number | A unique integer value identifying this user.
let opts = {
  'patchedUser': new LibreTimeApi.PatchedUser() // PatchedUser | 
};
apiInstance.usersPartialUpdate(id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let id = 56; // Number | A unique integer value identifying this user.
let user = new LibreTimeApi.User(); // User | 
apiInstance.usersUpdate(id, user, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
