...
class File {
     ...
     * @param mime {String} 
     * @param ftype {String} 
     * @param importStatus {Number} 
     * @param currentlyAccessing {Number} 
     * @param filesize {Number} 
     */
    constructor(itemUrl, id, name, mime, ftype, importStatus, currentlyAccessing, filesize) { 
        
        File.initialize(this, itemUrl, id, name, mime, ftype, importStatus, currentlyAccessing, filesize);
    }
     ...
     */
    static initialize(obj, itemUrl, id, name, mime, ftype, importStatus, currentlyAccessing, filesize) { 
        obj['item_url'] = itemUrl;
        obj['id'] = id;
        obj['name'] = name;
        obj['mime'] = mime;
        obj['ftype'] = ftype;
        obj['import_status'] = importStatus;
        obj['currently_accessing'] = currentlyAccessing;
 ...
 */
File.prototype['item_url'] = undefined;
 ...
 * @member {String} ftype
 */
File.prototype['ftype'] = undefined;
 ...
 */
File.prototype['import_status'] = undefined;

/**
 * @member {Number} currently_accessing
 */
File.prototype['currently_accessing'] = undefined;

/**
 * @member {Date} mtime
 */
File.prototype['mtime'] = undefined;

/**
 * @member {Date} utime
 */
File.prototype['utime'] = undefined;

/**
 * @member {Date} lptime
 */
File.prototype['lptime'] = undefined;

/**
 * @member {String} md5
 */
File.prototype['md5'] = undefined;

/**
 * @member {String} track_title
 */
File.prototype['track_title'] = undefined;

/**
 * @member {String} artist_name
 */
File.prototype['artist_name'] = undefined;

/**
 * @member {Number} bit_rate
 */
File.prototype['bit_rate'] = undefined;

/**
 * @member {Number} sample_rate
 */
File.prototype['sample_rate'] = undefined;
 ...
 */
File.prototype['length'] = undefined;

/**
 * @member {String} album_title
 */
File.prototype['album_title'] = undefined;

/**
 * @member {String} genre
 */
File.prototype['genre'] = undefined;
 ...
 * @member {String} year
 */
File.prototype['year'] = undefined;

/**
 * @member {Number} track_number
 */
File.prototype['track_number'] = undefined;

/**
 * @member {Number} channels
 */
File.prototype['channels'] = undefined;
 ...
 */
File.prototype['encoded_by'] = undefined;

/**
 * @member {String} disc_number
 */
File.prototype['disc_number'] = undefined;

/**
 * @member {String} mood
 */
File.prototype['mood'] = undefined;

/**
 * @member {String} label
 */
File.prototype['label'] = undefined;

/**
 * @member {String} composer
 */
File.prototype['composer'] = undefined;

/**
 * @member {String} encoder
 */
File.prototype['encoder'] = undefined;

/**
 * @member {String} checksum
 */
File.prototype['checksum'] = undefined;

/**
 * @member {String} lyrics
 */
File.prototype['lyrics'] = undefined;

/**
 * @member {String} orchestra
 */
File.prototype['orchestra'] = undefined;

/**
 * @member {String} conductor
 */
File.prototype['conductor'] = undefined;

/**
 * @member {String} lyricist
 */
File.prototype['lyricist'] = undefined;

/**
 * @member {String} original_lyricist
 */
File.prototype['original_lyricist'] = undefined;

/**
 * @member {String} radio_station_name
 */
File.prototype['radio_station_name'] = undefined;

/**
 * @member {String} info_url
 */
File.prototype['info_url'] = undefined;

/**
 * @member {String} artist_url
 */
File.prototype['artist_url'] = undefined;

/**
 * @member {String} audio_source_url
 */
File.prototype['audio_source_url'] = undefined;

/**
 * @member {String} radio_station_url
 */
File.prototype['radio_station_url'] = undefined;

/**
 * @member {String} buy_this_url
 */
File.prototype['buy_this_url'] = undefined;

/**
 * @member {String} isrc_number
 */
File.prototype['isrc_number'] = undefined;

/**
 * @member {String} catalog_number
 */
File.prototype['catalog_number'] = undefined;

/**
 * @member {String} original_artist
 */
File.prototype['original_artist'] = undefined;

/**
 * @member {String} copyright
 */
File.prototype['copyright'] = undefined;

/**
 * @member {String} report_datetime
 */
File.prototype['report_datetime'] = undefined;

/**
 * @member {String} report_location
 */
File.prototype['report_location'] = undefined;

/**
 * @member {String} report_organization
 */
File.prototype['report_organization'] = undefined;

/**
 * @member {String} subject
 */
File.prototype['subject'] = undefined;

/**
 * @member {String} contributor
 */
File.prototype['contributor'] = undefined;

/**
 * @member {String} language
 */
File.prototype['language'] = undefined;

/**
 * @member {Boolean} file_exists
 */
File.prototype['file_exists'] = undefined;

/**
 * @member {Number} replay_gain
 */
File.prototype['replay_gain'] = undefined;

/**
 * @member {String} cuein
 */
File.prototype['cuein'] = undefined;

/**
 * @member {String} cueout
 */
File.prototype['cueout'] = undefined;

/**
 * @member {Boolean} silan_check
 */
File.prototype['silan_check'] = undefined;
 ...
 */
File.prototype['is_scheduled'] = undefined;

/**
 * @member {Boolean} is_playlist
 */
File.prototype['is_playlist'] = undefined;
 ...
 */
File.prototype['artwork'] = undefined;

/**
 * @member {String} track_type
 */
File.prototype['track_type'] = undefined;
 ...
 */
File.prototype['edited_by'] = undefined;
