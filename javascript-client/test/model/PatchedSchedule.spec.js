...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedSchedule();
  });
  ...
  describe('PatchedSchedule', function() {
    it('should create an instance of PatchedSchedule', function() {
      // uncomment below and update the code to test PatchedSchedule
      //var instance = new LibreTimeApi.PatchedSchedule();
      //expect(instance).to.be.a(LibreTimeApi.PatchedSchedule);
    });
