...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.MountName();
  });
  ...
  describe('MountName', function() {
    it('should create an instance of MountName', function() {
      // uncomment below and update the code to test MountName
      //var instance = new LibreTimeApi.MountName();
      //expect(instance).to.be.a(LibreTimeApi.MountName);
    });
