...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.SmartBlockCriteria();
  });
  ...
  describe('SmartBlockCriteria', function() {
    it('should create an instance of SmartBlockCriteria', function() {
      // uncomment below and update the code to test SmartBlockCriteria
      //var instance = new LibreTimeApi.SmartBlockCriteria();
      //expect(instance).to.be.a(LibreTimeApi.SmartBlockCriteria);
    });
