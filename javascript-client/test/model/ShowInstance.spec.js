...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.ShowInstance();
  });
  ...
  describe('ShowInstance', function() {
    it('should create an instance of ShowInstance', function() {
      // uncomment below and update the code to test ShowInstance
      //var instance = new LibreTimeApi.ShowInstance();
      //expect(instance).to.be.a(LibreTimeApi.ShowInstance);
    });
