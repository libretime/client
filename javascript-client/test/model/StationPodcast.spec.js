...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.StationPodcast();
  });
  ...
  describe('StationPodcast', function() {
    it('should create an instance of StationPodcast', function() {
      // uncomment below and update the code to test StationPodcast
      //var instance = new LibreTimeApi.StationPodcast();
      //expect(instance).to.be.a(LibreTimeApi.StationPodcast);
    });
