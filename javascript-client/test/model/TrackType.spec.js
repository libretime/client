...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.TrackType();
  });
  ...
  describe('TrackType', function() {
    it('should create an instance of TrackType', function() {
      // uncomment below and update the code to test TrackType
      //var instance = new LibreTimeApi.TrackType();
      //expect(instance).to.be.a(LibreTimeApi.TrackType);
    });
