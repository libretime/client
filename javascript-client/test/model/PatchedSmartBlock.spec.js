...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedSmartBlock();
  });
  ...
  describe('PatchedSmartBlock', function() {
    it('should create an instance of PatchedSmartBlock', function() {
      // uncomment below and update the code to test PatchedSmartBlock
      //var instance = new LibreTimeApi.PatchedSmartBlock();
      //expect(instance).to.be.a(LibreTimeApi.PatchedSmartBlock);
    });
