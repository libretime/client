...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedPlaylist();
  });
  ...
  describe('PatchedPlaylist', function() {
    it('should create an instance of PatchedPlaylist', function() {
      // uncomment below and update the code to test PatchedPlaylist
      //var instance = new LibreTimeApi.PatchedPlaylist();
      //expect(instance).to.be.a(LibreTimeApi.PatchedPlaylist);
    });
