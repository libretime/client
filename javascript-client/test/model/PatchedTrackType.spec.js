...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedTrackType();
  });
  ...
  describe('PatchedTrackType', function() {
    it('should create an instance of PatchedTrackType', function() {
      // uncomment below and update the code to test PatchedTrackType
      //var instance = new LibreTimeApi.PatchedTrackType();
      //expect(instance).to.be.a(LibreTimeApi.PatchedTrackType);
    });
