...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.Webstream();
  });
  ...
  describe('Webstream', function() {
    it('should create an instance of Webstream', function() {
      // uncomment below and update the code to test Webstream
      //var instance = new LibreTimeApi.Webstream();
      //expect(instance).to.be.a(LibreTimeApi.Webstream);
    });
