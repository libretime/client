...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedPodcast();
  });
  ...
  describe('PatchedPodcast', function() {
    it('should create an instance of PatchedPodcast', function() {
      // uncomment below and update the code to test PatchedPodcast
      //var instance = new LibreTimeApi.PatchedPodcast();
      //expect(instance).to.be.a(LibreTimeApi.PatchedPodcast);
    });
