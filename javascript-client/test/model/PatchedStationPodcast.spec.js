...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedStationPodcast();
  });
  ...
  describe('PatchedStationPodcast', function() {
    it('should create an instance of PatchedStationPodcast', function() {
      // uncomment below and update the code to test PatchedStationPodcast
      //var instance = new LibreTimeApi.PatchedStationPodcast();
      //expect(instance).to.be.a(LibreTimeApi.PatchedStationPodcast);
    });
