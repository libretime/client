...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PatchedShowDays();
  });
  ...
  describe('PatchedShowDays', function() {
    it('should create an instance of PatchedShowDays', function() {
      // uncomment below and update the code to test PatchedShowDays
      //var instance = new LibreTimeApi.PatchedShowDays();
      //expect(instance).to.be.a(LibreTimeApi.PatchedShowDays);
    });
