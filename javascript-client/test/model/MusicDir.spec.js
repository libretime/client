...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.MusicDir();
  });
  ...
  describe('MusicDir', function() {
    it('should create an instance of MusicDir', function() {
      // uncomment below and update the code to test MusicDir
      //var instance = new LibreTimeApi.MusicDir();
      //expect(instance).to.be.a(LibreTimeApi.MusicDir);
    });
