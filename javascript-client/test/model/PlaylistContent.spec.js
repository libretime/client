...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.PlaylistContent();
  });
  ...
  describe('PlaylistContent', function() {
    it('should create an instance of PlaylistContent', function() {
      // uncomment below and update the code to test PlaylistContent
      //var instance = new LibreTimeApi.PlaylistContent();
      //expect(instance).to.be.a(LibreTimeApi.PlaylistContent);
    });
