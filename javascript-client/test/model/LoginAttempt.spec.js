...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.LoginAttempt();
  });
  ...
  describe('LoginAttempt', function() {
    it('should create an instance of LoginAttempt', function() {
      // uncomment below and update the code to test LoginAttempt
      //var instance = new LibreTimeApi.LoginAttempt();
      //expect(instance).to.be.a(LibreTimeApi.LoginAttempt);
    });
