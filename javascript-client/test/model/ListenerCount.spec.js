...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LibreTimeApi.ListenerCount();
  });
  ...
  describe('ListenerCount', function() {
    it('should create an instance of ListenerCount', function() {
      // uncomment below and update the code to test ListenerCount
      //var instance = new LibreTimeApi.ListenerCount();
      //expect(instance).to.be.a(LibreTimeApi.ListenerCount);
    });
