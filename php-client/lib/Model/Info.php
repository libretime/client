...
class Info implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('station_name', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['station_name'] === null) {
            $invalidProperties[] = "'station_name' can't be null";
        }
     ...
     * Sets station_name
     *
     * @param string $station_name station_name
     *
     * @return self
     */
    public function setStationName($station_name)
    {
        ...
        if (is_null($station_name)) {
            throw new \InvalidArgumentException('non-nullable station_name cannot be null');
        }
