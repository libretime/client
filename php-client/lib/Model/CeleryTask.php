 ...
 */
class CeleryTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CeleryTask';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['task_id']) > 256)) {
        ...
        if ((mb_strlen($this->container['status']) > 256)) {
            $invalidProperties[] = "invalid value for 'status', the character length must be smaller than or equal to 256.";
        }

        if ($this->container['track_reference'] === null) {
            $invalidProperties[] = "'track_reference' can't be null";
        }
    ...
    public function setTaskId($task_id)
    {
        ...
        if ((mb_strlen($task_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $task_id when calling CeleryTask., must be smaller than or equal to 256.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CeleryTask., must be smaller than or equal to 256.');
        }
    ...
    public function setStatus($status)
    {
        ...
        if ((mb_strlen($status) > 256)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CeleryTask., must be smaller than or equal to 256.');
        }
