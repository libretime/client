...
/**
 * StreamSetting Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class StreamSetting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamSetting';
    ...
    {
        if ((mb_strlen($key) > 64)) {
            throw new \InvalidArgumentException('invalid length for $key when calling StreamSetting., must be smaller than or equal to 64.');
        }
    ...
    public function setRawValue($raw_value)
    {
        if (!is_null($raw_value) && (mb_strlen($raw_value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $raw_value when calling StreamSetting., must be smaller than or equal to 255.');
        }
    ...
    public function setType($type)
    {
        if ((mb_strlen($type) > 16)) {
            throw new \InvalidArgumentException('invalid length for $type when calling StreamSetting., must be smaller than or equal to 16.');
        }
