...
/**
 * PatchedCloudFile Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedCloudFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedCloudFile';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['storage_backend']) && (mb_strlen($this->container['storage_backend']) > 512)) {
     ...
     *
     * @param string|null $storage_backend storage_backend
     *
     * @return self
     */
    public function setStorageBackend($storage_backend)
    {
        if (!is_null($storage_backend) && (mb_strlen($storage_backend) > 512)) {
            throw new \InvalidArgumentException('invalid length for $storage_backend when calling PatchedCloudFile., must be smaller than or equal to 512.');
        }
