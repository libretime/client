...
/**
 * SmartBlockContent Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class SmartBlockContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartBlockContent';
    ...
    */
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $position when calling SmartBlockContent., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($position) && ($position < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $position when calling SmartBlockContent., must be bigger than or equal to -2147483648.');
        }
