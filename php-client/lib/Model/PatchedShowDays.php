...
class PatchedShowDays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['repeat_type']) && ($this->container['repeat_type'] > 32767)) {
            $invalidProperties[] = "invalid value for 'repeat_type', must be smaller than or equal to 32767.";
        }

        if (!is_null($this->container['repeat_type']) && ($this->container['repeat_type'] < -32768)) {
     ...
     * Sets first_show
     *
     * @param \DateTime|null $first_show first_show
     *
     * @return self
     */
    ...
    public function setDay($day)
    {
        ...
        if (!is_null($day) && ($day > 32767)) {
            throw new \InvalidArgumentException('invalid value for $day when calling PatchedShowDays., must be smaller than or equal to 32767.');
        }
        if (!is_null($day) && ($day < -32768)) {
            throw new \InvalidArgumentException('invalid value for $day when calling PatchedShowDays., must be bigger than or equal to -32768.');
        }
     ...
     * Sets repeat_type
     *
     * @param int|null $repeat_type repeat_type
     *
     * @return self
     */
    public function setRepeatType($repeat_type)
    {
        ...
        if (!is_null($repeat_type) && ($repeat_type > 32767)) {
            throw new \InvalidArgumentException('invalid value for $repeat_type when calling PatchedShowDays., must be smaller than or equal to 32767.');
        }
        if (!is_null($repeat_type) && ($repeat_type < -32768)) {
            throw new \InvalidArgumentException('invalid value for $repeat_type when calling PatchedShowDays., must be bigger than or equal to -32768.');
        }
    ...
    public function setRecord($record)
    {
        ...
        if (!is_null($record) && ($record > 32767)) {
            throw new \InvalidArgumentException('invalid value for $record when calling PatchedShowDays., must be smaller than or equal to 32767.');
        }
        if (!is_null($record) && ($record < -32768)) {
            throw new \InvalidArgumentException('invalid value for $record when calling PatchedShowDays., must be bigger than or equal to -32768.');
        }
