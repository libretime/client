...
class PatchedImportedPodcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('override_album', $data ?? [], null);
        $this->setIfExists('auto_ingest', $data ?? [], null);
        $this->setIfExists('auto_ingested_at', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($override_album)) {
            throw new \InvalidArgumentException('non-nullable override_album cannot be null');
        }
    ...
    {
        if (is_null($auto_ingest)) {
            throw new \InvalidArgumentException('non-nullable auto_ingest cannot be null');
        }
    ...
    {
        if (is_null($auto_ingested_at)) {
            array_push($this->openAPINullablesSetToNull, 'auto_ingested_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('auto_ingested_at', $nullablesSetToNull);
            if ($index !== FALSE) {
