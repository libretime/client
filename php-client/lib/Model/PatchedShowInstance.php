...
class PatchedShowInstance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setRecord($record)
    {
        ...
        if (!is_null($record) && ($record > 32767)) {
            throw new \InvalidArgumentException('invalid value for $record when calling PatchedShowInstance., must be smaller than or equal to 32767.');
        }
        if (!is_null($record) && ($record < -32768)) {
            throw new \InvalidArgumentException('invalid value for $record when calling PatchedShowInstance., must be bigger than or equal to -32768.');
        }
     ...
     *
     * @param bool|null $modified_instance modified_instance
     *
     * @return self
     */
     ...
     *
     * @param bool|null $autoplaylist_built autoplaylist_built
     *
     * @return self
     */
