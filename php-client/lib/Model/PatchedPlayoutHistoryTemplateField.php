...
/**
 * PatchedPlayoutHistoryTemplateField Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedPlayoutHistoryTemplateField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedPlayoutHistoryTemplateField';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedPlayoutHistoryTemplateField., must be smaller than or equal to 128.');
        }
    ...
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 128)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PatchedPlayoutHistoryTemplateField., must be smaller than or equal to 128.');
        }
    ...
    {
        if (!is_null($type) && (mb_strlen($type) > 128)) {
            throw new \InvalidArgumentException('invalid length for $type when calling PatchedPlayoutHistoryTemplateField., must be smaller than or equal to 128.');
        }
     ...
     * Sets is_file_md
     *
     * @param bool|null $is_file_md is_file_md
     *
     * @return self
     */
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $position when calling PatchedPlayoutHistoryTemplateField., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($position) && ($position < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $position when calling PatchedPlayoutHistoryTemplateField., must be bigger than or equal to -2147483648.');
        }
