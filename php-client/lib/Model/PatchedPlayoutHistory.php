...
/**
 * PatchedPlayoutHistory Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedPlayoutHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedPlayoutHistory';
    ...
    */
    ...
    {
        if (is_null($ends)) {
            array_push($this->openAPINullablesSetToNull, 'ends');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ends', $nullablesSetToNull);
            if ($index !== FALSE) {
