...
class UserToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['token']) > 40)) {
    ...
    public function setAction($action)
    {
        ...
        if ((mb_strlen($action) > 255)) {
            throw new \InvalidArgumentException('invalid length for $action when calling UserToken., must be smaller than or equal to 255.');
        }
    ...
    public function setToken($token)
    {
        ...
        if ((mb_strlen($token) > 40)) {
            throw new \InvalidArgumentException('invalid length for $token when calling UserToken., must be smaller than or equal to 40.');
        }
