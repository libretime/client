 ...
 */
class ShowHost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShowHost';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['subjs'] === null) {
            $invalidProperties[] = "'subjs' can't be null";
        }
