...
/**
 * PatchedServiceRegister Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedServiceRegister implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedServiceRegister';
    ...
    */
    ...
    public function setIp($ip)
    {
        ...
        if ((mb_strlen($ip) > 45)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling PatchedServiceRegister., must be smaller than or equal to 45.');
        }
