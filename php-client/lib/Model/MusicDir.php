 ...
 */
class MusicDir implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MusicDir';
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $type when calling MusicDir., must be smaller than or equal to 255.');
        }
