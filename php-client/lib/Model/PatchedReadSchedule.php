...
/**
 * PatchedReadSchedule Class Doc Comment
 *
 * @category Class
 * @package  Libretime\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedReadSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedReadSchedule';
    ...
    */
    ...
    public function setPosition($position)
    {
        ...
        if (($position > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $position when calling PatchedReadSchedule., must be smaller than or equal to 2147483647.');
        }
        if (($position < -2147483648)) {
            throw new \InvalidArgumentException('invalid value for $position when calling PatchedReadSchedule., must be bigger than or equal to -2147483648.');
        }
    ...
    public function setBroadcasted($broadcasted)
    {
        ...
        if (($broadcasted > 32767)) {
            throw new \InvalidArgumentException('invalid value for $broadcasted when calling PatchedReadSchedule., must be smaller than or equal to 32767.');
        }
        if (($broadcasted < -32768)) {
            throw new \InvalidArgumentException('invalid value for $broadcasted when calling PatchedReadSchedule., must be bigger than or equal to -32768.');
        }
