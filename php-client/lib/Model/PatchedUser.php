...
class PatchedUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets type
     *
     * @return \Libretime\Client\Model\TypeEnum|null
     */
     ...
     * Sets type
     *
     * @param \Libretime\Client\Model\TypeEnum|null $type type
     *
     * @return self
     */
    ...
    public function setSkypeContact($skype_contact)
    {
        if (!is_null($skype_contact) && (mb_strlen($skype_contact) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $skype_contact when calling PatchedUser., must be smaller than or equal to 1024.');
        }
    ...
    public function setJabberContact($jabber_contact)
    {
        if (!is_null($jabber_contact) && (mb_strlen($jabber_contact) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $jabber_contact when calling PatchedUser., must be smaller than or equal to 1024.');
        }
    ...
    public function setCellPhone($cell_phone)
    {
        if (!is_null($cell_phone) && (mb_strlen($cell_phone) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $cell_phone when calling PatchedUser., must be smaller than or equal to 1024.');
        }
