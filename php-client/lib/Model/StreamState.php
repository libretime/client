...
class StreamState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['input_main_connected'] = $data['input_main_connected'] ?? null;
        $this->container['input_main_streaming'] = $data['input_main_streaming'] ?? null;
        $this->container['input_show_connected'] = $data['input_show_connected'] ?? null;
        $this->container['input_show_streaming'] = $data['input_show_streaming'] ?? null;
        $this->container['schedule_streaming'] = $data['schedule_streaming'] ?? null;
    }
