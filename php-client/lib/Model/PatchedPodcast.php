...
class PatchedPodcast implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['itunes_author'] = $data['itunes_author'] ?? null;
        $this->container['itunes_keywords'] = $data['itunes_keywords'] ?? null;
        $this->container['itunes_summary'] = $data['itunes_summary'] ?? null;
        $this->container['itunes_subtitle'] = $data['itunes_subtitle'] ?? null;
        $this->container['itunes_category'] = $data['itunes_category'] ?? null;
        $this->container['itunes_explicit'] = $data['itunes_explicit'] ?? null;
    ...
    {
        if (!is_null($url) && (mb_strlen($url) > 4096)) {
    ...
    {
        if (!is_null($title) && (mb_strlen($title) > 4096)) {
