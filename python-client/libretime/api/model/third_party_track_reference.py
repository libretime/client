...
class ThirdPartyTrackReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, item_url, service, *args, **kwargs):  # noqa: E501
        """ThirdPartyTrackReference - a model defined in OpenAPI
