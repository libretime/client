...
class PlayoutHistoryTemplateField(ModelNormal):
    ...
    attribute_map = {
        ...
        'type': 'type',  # noqa: E501
        'is_file_md': 'is_file_md',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, label, type, is_file_md, position, template, *args, **kwargs):  # noqa: E501
        """PlayoutHistoryTemplateField - a model defined in OpenAPI
