...
class PlaylistContent(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'stream_id': (int, none_type,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, item_url, type, trackoffset, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            stream_id (int, none_type): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, trackoffset, *args, **kwargs):  # noqa: E501
        """PlaylistContent - a model defined in OpenAPI
