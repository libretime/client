...
from libretime.api import rest
from libretime.api.configuration import Configuration
from libretime.api.exceptions import ApiTypeError, ApiValueError, ApiException
from libretime.api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CeleryTasksApi()
        api_instance.celery_tasks_create  # this is an instance of the class Endpoint
        api_instance.celery_tasks_create()  # this invokes api_instance.celery_tasks_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.celery_tasks_create.callable or self.callable in this class
