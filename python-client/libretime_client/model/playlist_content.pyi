...
class PlaylistContent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "kind", "offset", "position", "length", "cue_in", "cue_out", "fade_in", "fade_out", "playlist", "file", "stream", "block", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "kind", "offset", "position", "length", "cue_in", "cue_out", "fade_in", "fade_out", "playlist", "file", "stream", "block", ], str]):
