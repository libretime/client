...
class SmartBlock(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "created_at", "updated_at", "description", "length", "kind", "owner", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "created_at", "updated_at", "description", "length", "kind", "owner", ], str]):
