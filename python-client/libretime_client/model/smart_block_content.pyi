...
class SmartBlockContent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "offset", "position", "length", "cue_in", "cue_out", "fade_in", "fade_out", "block", "file", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "offset", "position", "length", "cue_in", "cue_out", "fade_in", "fade_out", "block", "file", ], str]):
