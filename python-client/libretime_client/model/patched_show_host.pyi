...
class PatchedShowHost(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "show", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "show", "user", ], str]):
