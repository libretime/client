...
class PatchedPreference(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "key", "value", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "key", "value", "user", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        user: typing.Union[MetaOapg.properties.user, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
