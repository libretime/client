...
class PatchedWebstream(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "updated_at", "last_played_at", "name", "description", "url", "length", "mime", "owner", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "updated_at", "last_played_at", "name", "description", "url", "length", "mime", "owner", ], str]):
