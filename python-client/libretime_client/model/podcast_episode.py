...
class PodcastEpisode(
    ...
    episode_guid: MetaOapg.properties.episode_guid
    podcast: MetaOapg.properties.podcast
    download_url: MetaOapg.properties.download_url
    episode_title: MetaOapg.properties.episode_title
    id: MetaOapg.properties.id
    published_at: MetaOapg.properties.published_at
    episode_description: MetaOapg.properties.episode_description
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["episode_guid"]) -> MetaOapg.properties.episode_guid: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["episode_title"]) -> MetaOapg.properties.episode_title: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["episode_description"]) -> MetaOapg.properties.episode_description: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        episode_title: typing.Union[MetaOapg.properties.episode_title, str, ],
        id: typing.Union[MetaOapg.properties.id, decimal.Decimal, int, ],
        published_at: typing.Union[MetaOapg.properties.published_at, str, datetime, ],
        episode_description: typing.Union[MetaOapg.properties.episode_description, str, ],
