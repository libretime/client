...
class File(BaseModel):
    ...
    size: conint(strict=True, le=2147483647, ge=-2147483648) = Field(...)
    exists: Optional[StrictBool] = None
    mime: constr(strict=True, max_length=255) = Field(...)
    md5: Optional[constr(strict=True, max_length=32)] = None
    hidden: Optional[StrictBool] = None
    accessed: conint(strict=True, le=2147483647, ge=-2147483648) = Field(...)
