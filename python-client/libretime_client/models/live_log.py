...
class LiveLog(BaseModel):
    ...
    """
    id: StrictInt = Field(...)
    state: constr(strict=True, max_length=32) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LiveLog:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LiveLog:
        """Create an instance of LiveLog from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LiveLog.parse_obj(obj)

        _obj = LiveLog.parse_obj({
            "id": obj.get("id"),
            "state": obj.get("state"),
