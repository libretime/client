...
class PatchedPreference(BaseModel):
    """
    PatchedPreference
    """
    id: Optional[StrictInt] = None
    key: Optional[constr(strict=True, max_length=255)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedPreference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedPreference:
        """Create an instance of PatchedPreference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedPreference.parse_obj(obj)

        _obj = PatchedPreference.parse_obj({
            "id": obj.get("id"),
            "key": obj.get("key"),
            "value": obj.get("value"),
            "user": obj.get("user")
