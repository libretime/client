...
class PatchedShowDays(BaseModel):
    """
    PatchedShowDays
    """
    id: Optional[StrictInt] = None
    first_show_on: Optional[date] = None
    last_show_on: Optional[date] = None
    start_time: Optional[StrictStr] = None
    timezone: Optional[constr(strict=True, max_length=1024)] = None
    duration: Optional[constr(strict=True, max_length=1024)] = None
    record_enabled: Optional[RecordEnabledEnum] = None
    week_day: Optional[WeekDayEnum] = None
    repeat_kind: Optional[RepeatKindEnum] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedShowDays:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedShowDays:
        """Create an instance of PatchedShowDays from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedShowDays.parse_obj(obj)

        _obj = PatchedShowDays.parse_obj({
            "id": obj.get("id"),
