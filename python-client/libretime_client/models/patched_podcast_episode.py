...
class PatchedPodcastEpisode(BaseModel):
    """
    PatchedPodcastEpisode
    """
    id: Optional[StrictInt] = None
    published_at: Optional[datetime] = None
    download_url: Optional[constr(strict=True, max_length=4096)] = None
    episode_guid: Optional[constr(strict=True, max_length=4096)] = None
    episode_title: Optional[constr(strict=True, max_length=4096)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedPodcastEpisode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedPodcastEpisode:
        """Create an instance of PatchedPodcastEpisode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedPodcastEpisode.parse_obj(obj)

        _obj = PatchedPodcastEpisode.parse_obj({
            "id": obj.get("id"),
