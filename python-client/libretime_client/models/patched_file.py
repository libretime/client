...
class PatchedFile(BaseModel):
    ...
    mime: Optional[constr(strict=True, max_length=255)] = None
    md5: Optional[constr(strict=True, max_length=32)] = None
    hidden: Optional[StrictBool] = None
    accessed: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = None
    scheduled: Optional[StrictBool] = None
    part_of_list: Optional[StrictBool] = None
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    last_played_at: Optional[datetime] = None
    bit_rate: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = None
    sample_rate: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = None
    format: Optional[constr(strict=True, max_length=128)] = None
    channels: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = None
    length: Optional[StrictStr] = None
    bpm: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = None
    replay_gain: Optional[constr(strict=True)] = None
    ...
    artwork: Optional[constr(strict=True, max_length=512)] = None
    artist_name: Optional[constr(strict=True, max_length=512)] = None
    artist_url: Optional[constr(strict=True, max_length=512)] = None
    original_artist: Optional[constr(strict=True, max_length=512)] = None
    album_title: Optional[constr(strict=True, max_length=512)] = None
    track_title: Optional[constr(strict=True, max_length=512)] = None
    genre: Optional[constr(strict=True, max_length=64)] = None
    mood: Optional[constr(strict=True, max_length=64)] = None
    var_date: Optional[constr(strict=True, max_length=16)] = Field(None, alias="date")
    track_number: Optional[conint(strict=True, le=2147483647, ge=-2147483648)] = None
    disc_number: Optional[constr(strict=True, max_length=8)] = None
    comment: Optional[StrictStr] = None
    language: Optional[constr(strict=True, max_length=512)] = None
    label: Optional[constr(strict=True, max_length=512)] = None
    copyright: Optional[constr(strict=True, max_length=512)] = None
    composer: Optional[constr(strict=True, max_length=512)] = None
    conductor: Optional[constr(strict=True, max_length=512)] = None
    orchestra: Optional[constr(strict=True, max_length=512)] = None
    encoder: Optional[constr(strict=True, max_length=64)] = None
    encoded_by: Optional[constr(strict=True, max_length=255)] = None
    isrc: Optional[constr(strict=True, max_length=512)] = None
    lyrics: Optional[StrictStr] = None
    lyricist: Optional[constr(strict=True, max_length=512)] = None
    original_lyricist: Optional[constr(strict=True, max_length=512)] = None
    subject: Optional[constr(strict=True, max_length=512)] = None
    contributor: Optional[constr(strict=True, max_length=512)] = None
    rating: Optional[constr(strict=True, max_length=8)] = None
    url: Optional[constr(strict=True, max_length=1024)] = None
    info_url: Optional[constr(strict=True, max_length=512)] = None
    audio_source_url: Optional[constr(strict=True, max_length=512)] = None
    buy_this_url: Optional[constr(strict=True, max_length=512)] = None
    catalog_number: Optional[constr(strict=True, max_length=512)] = None
    radio_station_name: Optional[constr(strict=True, max_length=512)] = None
    radio_station_url: Optional[constr(strict=True, max_length=512)] = None
    report_datetime: Optional[constr(strict=True, max_length=32)] = None
    report_location: Optional[constr(strict=True, max_length=512)] = None
    report_organization: Optional[constr(strict=True, max_length=512)] = None
    library: Optional[StrictInt] = None
    owner: Optional[StrictInt] = None
    edited_by: Optional[StrictInt] = None
    __properties = ["id", "import_status", "filepath", "size", "exists", "mime", "md5", "hidden", "accessed", "scheduled", "part_of_list", "created_at", "updated_at", "last_played_at", "bit_rate", "sample_rate", "format", "channels", "length", "bpm", "replay_gain", "cue_in", "cue_out", "name", "description", "artwork", "artist_name", "artist_url", "original_artist", "album_title", "track_title", "genre", "mood", "date", "track_number", "disc_number", "comment", "language", "label", "copyright", "composer", "conductor", "orchestra", "encoder", "encoded_by", "isrc", "lyrics", "lyricist", "original_lyricist", "subject", "contributor", "rating", "url", "info_url", "audio_source_url", "buy_this_url", "catalog_number", "radio_station_name", "radio_station_url", "report_datetime", "report_location", "report_organization", "library", "owner", "edited_by"]

    @validator('replay_gain')
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedFile:
    ...
    def to_dict(self):
        ...
        if self.filepath is None and "filepath" in self.__fields_set__:
            _dict['filepath'] = None

        # set to None if exists (nullable) is None
        # and __fields_set__ contains the field
        if self.exists is None and "exists" in self.__fields_set__:
            _dict['exists'] = None
        ...
        # and __fields_set__ contains the field
        if self.hidden is None and "hidden" in self.__fields_set__:
            _dict['hidden'] = None

        # set to None if scheduled (nullable) is None
        # and __fields_set__ contains the field
        if self.scheduled is None and "scheduled" in self.__fields_set__:
            _dict['scheduled'] = None

        # set to None if part_of_list (nullable) is None
        # and __fields_set__ contains the field
        if self.part_of_list is None and "part_of_list" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.bpm is None and "bpm" in self.__fields_set__:
            _dict['bpm'] = None

        # set to None if replay_gain (nullable) is None
        # and __fields_set__ contains the field
        if self.replay_gain is None and "replay_gain" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.artwork is None and "artwork" in self.__fields_set__:
            _dict['artwork'] = None
        ...
        # and __fields_set__ contains the field
        if self.artist_url is None and "artist_url" in self.__fields_set__:
            _dict['artist_url'] = None

        # set to None if original_artist (nullable) is None
        # and __fields_set__ contains the field
        if self.original_artist is None and "original_artist" in self.__fields_set__:
            _dict['original_artist'] = None

        # set to None if album_title (nullable) is None
        # and __fields_set__ contains the field
        if self.album_title is None and "album_title" in self.__fields_set__:
            _dict['album_title'] = None

        # set to None if track_title (nullable) is None
        # and __fields_set__ contains the field
        if self.track_title is None and "track_title" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.mood is None and "mood" in self.__fields_set__:
            _dict['mood'] = None
        ...
        # and __fields_set__ contains the field
        if self.track_number is None and "track_number" in self.__fields_set__:
            _dict['track_number'] = None

        # set to None if disc_number (nullable) is None
        # and __fields_set__ contains the field
        if self.disc_number is None and "disc_number" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.composer is None and "composer" in self.__fields_set__:
            _dict['composer'] = None

        # set to None if conductor (nullable) is None
        # and __fields_set__ contains the field
        if self.conductor is None and "conductor" in self.__fields_set__:
            _dict['conductor'] = None

        # set to None if orchestra (nullable) is None
        # and __fields_set__ contains the field
        if self.orchestra is None and "orchestra" in self.__fields_set__:
            _dict['orchestra'] = None

        # set to None if encoder (nullable) is None
        # and __fields_set__ contains the field
        if self.encoder is None and "encoder" in self.__fields_set__:
            _dict['encoder'] = None

        # set to None if encoded_by (nullable) is None
        # and __fields_set__ contains the field
        if self.encoded_by is None and "encoded_by" in self.__fields_set__:
            _dict['encoded_by'] = None

        # set to None if isrc (nullable) is None
        # and __fields_set__ contains the field
        if self.isrc is None and "isrc" in self.__fields_set__:
            _dict['isrc'] = None

        # set to None if lyrics (nullable) is None
        # and __fields_set__ contains the field
        if self.lyrics is None and "lyrics" in self.__fields_set__:
            _dict['lyrics'] = None

        # set to None if lyricist (nullable) is None
        # and __fields_set__ contains the field
        if self.lyricist is None and "lyricist" in self.__fields_set__:
            _dict['lyricist'] = None

        # set to None if original_lyricist (nullable) is None
        # and __fields_set__ contains the field
        if self.original_lyricist is None and "original_lyricist" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.contributor is None and "contributor" in self.__fields_set__:
        ...
        # and __fields_set__ contains the field
        if self.info_url is None and "info_url" in self.__fields_set__:
            _dict['info_url'] = None

        # set to None if audio_source_url (nullable) is None
        # and __fields_set__ contains the field
        if self.audio_source_url is None and "audio_source_url" in self.__fields_set__:
            _dict['audio_source_url'] = None

        # set to None if buy_this_url (nullable) is None
        # and __fields_set__ contains the field
        if self.buy_this_url is None and "buy_this_url" in self.__fields_set__:
            _dict['buy_this_url'] = None

        # set to None if catalog_number (nullable) is None
        # and __fields_set__ contains the field
        if self.catalog_number is None and "catalog_number" in self.__fields_set__:
            _dict['catalog_number'] = None

        # set to None if radio_station_name (nullable) is None
        # and __fields_set__ contains the field
        if self.radio_station_name is None and "radio_station_name" in self.__fields_set__:
            _dict['radio_station_name'] = None

        # set to None if radio_station_url (nullable) is None
        # and __fields_set__ contains the field
        if self.radio_station_url is None and "radio_station_url" in self.__fields_set__:
            _dict['radio_station_url'] = None

        # set to None if report_datetime (nullable) is None
        # and __fields_set__ contains the field
        if self.report_datetime is None and "report_datetime" in self.__fields_set__:
            _dict['report_datetime'] = None

        # set to None if report_location (nullable) is None
        # and __fields_set__ contains the field
        if self.report_location is None and "report_location" in self.__fields_set__:
            _dict['report_location'] = None

        # set to None if report_organization (nullable) is None
        # and __fields_set__ contains the field
        if self.report_organization is None and "report_organization" in self.__fields_set__:
            _dict['report_organization'] = None

        # set to None if library (nullable) is None
        # and __fields_set__ contains the field
        if self.library is None and "library" in self.__fields_set__:
            _dict['library'] = None
        ...
        # and __fields_set__ contains the field
        if self.edited_by is None and "edited_by" in self.__fields_set__:
            _dict['edited_by'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> PatchedFile:
        """Create an instance of PatchedFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedFile.parse_obj(obj)

        _obj = PatchedFile.parse_obj({
            "id": obj.get("id"),
