...
class CeleryTask(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt
    task_id: Annotated[str, Field(strict=True, max_length=256)]
    name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = None
    dispatch_time: Optional[datetime] = None
    status: Annotated[str, Field(strict=True, max_length=256)]
    track_reference: StrictInt
    __properties: ClassVar[List[str]] = ["id", "task_id", "name", "dispatch_time", "status", "track_reference"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.dispatch_time is None and "dispatch_time" in self.model_fields_set:
