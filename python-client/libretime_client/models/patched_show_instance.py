...
class PatchedShowInstance(BaseModel):
    """
    PatchedShowInstance
    """
    ...
    auto_playlist_built: Optional[StrictBool] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedShowInstance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedShowInstance:
        """Create an instance of PatchedShowInstance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedShowInstance.parse_obj(obj)

        _obj = PatchedShowInstance.parse_obj({
            "id": obj.get("id"),
