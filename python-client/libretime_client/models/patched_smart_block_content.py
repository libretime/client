...
class PatchedSmartBlockContent(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedSmartBlockContent:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedSmartBlockContent:
        """Create an instance of PatchedSmartBlockContent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedSmartBlockContent.parse_obj(obj)

        _obj = PatchedSmartBlockContent.parse_obj({
            "id": obj.get("id"),
