...
class PatchedSmartBlockCriteria(BaseModel):
    ...
    criteria: Optional[constr(strict=True, max_length=32)] = None
    condition: Optional[constr(strict=True, max_length=16)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedSmartBlockCriteria:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedSmartBlockCriteria:
        """Create an instance of PatchedSmartBlockCriteria from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedSmartBlockCriteria.parse_obj(obj)

        _obj = PatchedSmartBlockCriteria.parse_obj({
            "id": obj.get("id"),
            "group": obj.get("group"),
