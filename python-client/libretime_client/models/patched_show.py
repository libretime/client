...
class PatchedShow(BaseModel):
    ...
    linkable: Optional[StrictBool] = None
    auto_playlist: Optional[StrictInt] = None
    auto_playlist_enabled: Optional[StrictBool] = None
    auto_playlist_repeat: Optional[StrictBool] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedShow:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedShow:
        """Create an instance of PatchedShow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedShow.parse_obj(obj)

        _obj = PatchedShow.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
