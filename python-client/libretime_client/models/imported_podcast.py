...
class ImportedPodcast(BaseModel):
    """
    ImportedPodcast
    """
    id: StrictInt = Field(...)
    override_album: StrictBool = Field(...)
    auto_ingest: StrictBool = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImportedPodcast:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImportedPodcast:
        """Create an instance of ImportedPodcast from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImportedPodcast.parse_obj(obj)

        _obj = ImportedPodcast.parse_obj({
            "id": obj.get("id"),
