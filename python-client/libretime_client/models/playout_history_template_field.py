...
class PlayoutHistoryTemplateField(BaseModel):
    ...
    label: Annotated[str, Field(strict=True, max_length=128)]
    type: Annotated[str, Field(strict=True, max_length=128)]
    is_file_md: StrictBool
    position: Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]
    template: StrictInt
    __properties: ClassVar[List[str]] = ["id", "name", "label", "type", "is_file_md", "position", "template"]
