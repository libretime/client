...
class SmartBlockCriteria(BaseModel):
    ...
    criteria: Annotated[str, Field(strict=True, max_length=32)]
    condition: Annotated[str, Field(strict=True, max_length=16)]
    value: Annotated[str, Field(strict=True, max_length=512)]
