...
class PatchedPodcast(BaseModel):
    ...
    url: Optional[constr(strict=True, max_length=4096)] = None
    title: Optional[constr(strict=True, max_length=4096)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedPodcast:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedPodcast:
        """Create an instance of PatchedPodcast from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedPodcast.parse_obj(obj)

        _obj = PatchedPodcast.parse_obj({
            "id": obj.get("id"),
            "url": obj.get("url"),
            "title": obj.get("title"),
