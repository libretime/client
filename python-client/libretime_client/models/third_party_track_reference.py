...
class ThirdPartyTrackReference(BaseModel):
    """
    ThirdPartyTrackReference
    """ # noqa: E501
    id: StrictInt
    service: Annotated[str, Field(strict=True, max_length=256)]
    foreign_id: Optional[Annotated[str, Field(strict=True, max_length=256)]] = None
    upload_time: Optional[datetime] = None
    status: Optional[Annotated[str, Field(strict=True, max_length=256)]] = None
    file: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "service", "foreign_id", "upload_time", "status", "file"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.upload_time is None and "upload_time" in self.model_fields_set:
