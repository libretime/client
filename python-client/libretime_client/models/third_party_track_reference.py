...
class ThirdPartyTrackReference(BaseModel):
    ...
    """
    id: StrictInt = Field(...)
    service: constr(strict=True, max_length=256) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ThirdPartyTrackReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ThirdPartyTrackReference:
        """Create an instance of ThirdPartyTrackReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ThirdPartyTrackReference.parse_obj(obj)

        _obj = ThirdPartyTrackReference.parse_obj({
            "id": obj.get("id"),
