...
class PatchedPlaylist(BaseModel):
    """
    PatchedPlaylist
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedPlaylist:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedPlaylist:
        """Create an instance of PatchedPlaylist from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedPlaylist.parse_obj(obj)

        _obj = PatchedPlaylist.parse_obj({
            "id": obj.get("id"),
