...
class CountriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.countries_create_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v2/countries/',
                'operation_id': 'countries_create',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.countries_destroy_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth',
        ...
        self.countries_list_endpoint = _Endpoint(
            settings={
                'response_type': ([Country],),
                'auth': [
                    'basicAuth',
        ...
        self.countries_partial_update_endpoint = _Endpoint(
            settings={
                'response_type': (Country,),
                'auth': [
                    'basicAuth',
        ...
        self.countries_retrieve_endpoint = _Endpoint(
            settings={
                'response_type': (Country,),
                'auth': [
                    'basicAuth',
        ...
        self.countries_update_endpoint = _Endpoint(
            settings={
                'response_type': (Country,),
                'auth': [
                    'basicAuth',
    ...
    def countries_create(
        ...
        **kwargs
        ...
        >>> thread = api.countries_create(country, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['country'] = \
            country
        return self.countries_create_endpoint.call_with_http_info(**kwargs)
    ...
    def countries_list(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.countries_list_endpoint.call_with_http_info(**kwargs)
