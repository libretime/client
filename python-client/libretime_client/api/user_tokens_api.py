...
class UserTokensApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.user_tokens_create_endpoint = _Endpoint(
            settings={
                'response_type': (UserToken,),
                'auth': [
                    'basicAuth',
                    'cookieAuth'
                ],
        ...
        self.user_tokens_destroy_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'basicAuth',
        ...
        self.user_tokens_list_endpoint = _Endpoint(
            settings={
                'response_type': ([UserToken],),
                'auth': [
                    'basicAuth',
        ...
        self.user_tokens_partial_update_endpoint = _Endpoint(
            settings={
                'response_type': (UserToken,),
                'auth': [
                    'basicAuth',
        ...
        self.user_tokens_retrieve_endpoint = _Endpoint(
            settings={
                'response_type': (UserToken,),
                'auth': [
                    'basicAuth',
        ...
        self.user_tokens_update_endpoint = _Endpoint(
            settings={
                'response_type': (UserToken,),
                'auth': [
                    'basicAuth',
    ...
    def user_tokens_create(
        ...
        **kwargs
        ...
        kwargs['user_token'] = \
            user_token
        return self.user_tokens_create_endpoint.call_with_http_info(**kwargs)
    ...
    def user_tokens_destroy(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.user_tokens_destroy_endpoint.call_with_http_info(**kwargs)
    ...
    def user_tokens_list(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.user_tokens_list_endpoint.call_with_http_info(**kwargs)
    ...
    def user_tokens_partial_update(
        ...
        **kwargs
        ...
        >>> thread = api.user_tokens_partial_update(id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            patched_user_token (PatchedUserToken): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['id'] = \
            id
        return self.user_tokens_partial_update_endpoint.call_with_http_info(**kwargs)
    ...
    def user_tokens_retrieve(
        ...
        **kwargs
        ...
        kwargs['id'] = \
            id
        return self.user_tokens_retrieve_endpoint.call_with_http_info(**kwargs)
    ...
    def user_tokens_update(
        ...
        **kwargs
        ...
        kwargs['user_token'] = \
            user_token
        return self.user_tokens_update_endpoint.call_with_http_info(**kwargs)
