...
# body param
SchemaForRequestBodyApplicationJson = PatchedPreference
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedPreference
SchemaForRequestBodyMultipartFormData = PatchedPreference


request_body_patched_preference = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Preference
...
class BaseApi(api_client.Api):
    ...
    def _preferences_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_preference.serialize(body, content_type)
