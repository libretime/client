...
# body param
SchemaForRequestBodyApplicationJson = ShowHost
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ShowHost
SchemaForRequestBodyMultipartFormData = ShowHost


request_body_show_host = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _show_hosts_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_show_host.serialize(body, content_type)
...
class ShowHostsUpdate(BaseApi):
    ...
    def show_hosts_update(
        ...
        return self._show_hosts_update_oapg(
            body=body,
