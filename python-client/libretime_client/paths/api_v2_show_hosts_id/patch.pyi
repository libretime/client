...
# body param
SchemaForRequestBodyApplicationJson = PatchedShowHost
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedShowHost
SchemaForRequestBodyMultipartFormData = PatchedShowHost


request_body_patched_show_host = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ShowHost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _show_hosts_partial_update_oapg(
        self,
    ...
    def _show_hosts_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_show_host.serialize(body, content_type)
...
class ShowHostsPartialUpdate(BaseApi):
    ...
    def show_hosts_partial_update(
        ...
        return self._show_hosts_partial_update_oapg(
            body=body,
