...
# body param
SchemaForRequestBodyApplicationJson = ImportedPodcast
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ImportedPodcast
SchemaForRequestBodyMultipartFormData = ImportedPodcast


request_body_imported_podcast = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ImportedPodcast
...
class BaseApi(api_client.Api):
    @typing.overload
    def _imported_podcasts_create_oapg(
        self,
    ...
    def _imported_podcasts_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_imported_podcast.serialize(body, content_type)
...
class ImportedPodcastsCreate(BaseApi):
    ...
    def imported_podcasts_create(
        ...
        return self._imported_podcasts_create_oapg(
            body=body,
