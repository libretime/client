...
# body param
SchemaForRequestBodyApplicationJson = StationPodcast
SchemaForRequestBodyApplicationXWwwFormUrlencoded = StationPodcast
SchemaForRequestBodyMultipartFormData = StationPodcast


request_body_station_podcast = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _station_podcasts_update_oapg(
        self,
    ...
    def _station_podcasts_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_station_podcast.serialize(body, content_type)
...
class StationPodcastsUpdate(BaseApi):
    ...
    def station_podcasts_update(
        ...
        return self._station_podcasts_update_oapg(
            body=body,
