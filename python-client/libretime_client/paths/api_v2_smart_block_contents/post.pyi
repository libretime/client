...
SchemaFor201ResponseBodyApplicationJson = SmartBlockContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _smart_block_contents_create_oapg(
        self,
...
class SmartBlockContentsCreate(BaseApi):
    ...
    def smart_block_contents_create(
        ...
        return self._smart_block_contents_create_oapg(
            body=body,
