...
# body param
SchemaForRequestBodyApplicationJson = Playlist
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Playlist
SchemaForRequestBodyMultipartFormData = Playlist


request_body_playlist = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Playlist
...
class BaseApi(api_client.Api):
    ...
    def _playlists_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_playlist.serialize(body, content_type)
...
class PlaylistsCreate(BaseApi):
    ...
    def playlists_create(
        ...
        return self._playlists_create_oapg(
            body=body,
