...
# body param
SchemaForRequestBodyApplicationJson = ShowRebroadcast
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ShowRebroadcast
SchemaForRequestBodyMultipartFormData = ShowRebroadcast


request_body_show_rebroadcast = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _show_rebroadcasts_update_oapg(
        self,
    ...
    def _show_rebroadcasts_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_show_rebroadcast.serialize(body, content_type)
...
class ShowRebroadcastsUpdate(BaseApi):
    ...
    def show_rebroadcasts_update(
        ...
        return self._show_rebroadcasts_update_oapg(
            body=body,
