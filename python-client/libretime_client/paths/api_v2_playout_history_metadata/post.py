...
# body param
SchemaForRequestBodyApplicationJson = PlayoutHistoryMetadata
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PlayoutHistoryMetadata
SchemaForRequestBodyMultipartFormData = PlayoutHistoryMetadata


request_body_playout_history_metadata = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PlayoutHistoryMetadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _playout_history_metadata_create_oapg(
        self,
    ...
    def _playout_history_metadata_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_playout_history_metadata.serialize(body, content_type)
...
class PlayoutHistoryMetadataCreate(BaseApi):
    ...
    def playout_history_metadata_create(
        ...
        return self._playout_history_metadata_create_oapg(
            body=body,
