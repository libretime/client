...
# body param
SchemaForRequestBodyApplicationJson = ShowDays
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ShowDays
SchemaForRequestBodyMultipartFormData = ShowDays


request_body_show_days = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _show_days_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_show_days.serialize(body, content_type)
...
class ShowDaysUpdate(BaseApi):
    ...
    def show_days_update(
        ...
        return self._show_days_update_oapg(
            body=body,
