...
# body param
SchemaForRequestBodyApplicationJson = Schedule
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Schedule
SchemaForRequestBodyMultipartFormData = Schedule


request_body_schedule = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _schedule_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_schedule.serialize(body, content_type)
...
class ScheduleUpdate(BaseApi):
    ...
    def schedule_update(
        ...
        return self._schedule_update_oapg(
            body=body,
