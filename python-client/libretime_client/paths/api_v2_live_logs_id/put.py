...
# body param
SchemaForRequestBodyApplicationJson = LiveLog
SchemaForRequestBodyApplicationXWwwFormUrlencoded = LiveLog
SchemaForRequestBodyMultipartFormData = LiveLog


request_body_live_log = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _live_logs_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_live_log.serialize(body, content_type)
...
class LiveLogsUpdate(BaseApi):
    ...
    def live_logs_update(
        ...
        return self._live_logs_update_oapg(
            body=body,
