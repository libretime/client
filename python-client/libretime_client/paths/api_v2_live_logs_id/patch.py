...
# body param
SchemaForRequestBodyApplicationJson = PatchedLiveLog
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedLiveLog
SchemaForRequestBodyMultipartFormData = PatchedLiveLog


request_body_patched_live_log = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = LiveLog
...
class BaseApi(api_client.Api):
    @typing.overload
    def _live_logs_partial_update_oapg(
        self,
    ...
    def _live_logs_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_live_log.serialize(body, content_type)
...
class LiveLogsPartialUpdate(BaseApi):
    ...
    def live_logs_partial_update(
        ...
        return self._live_logs_partial_update_oapg(
            body=body,
