...
# body param
SchemaForRequestBodyApplicationJson = PatchedTimestamp
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedTimestamp
SchemaForRequestBodyMultipartFormData = PatchedTimestamp


request_body_patched_timestamp = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Timestamp
...
class BaseApi(api_client.Api):
    @typing.overload
    def _timestamps_partial_update_oapg(
        self,
    ...
    def _timestamps_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_timestamp.serialize(body, content_type)
...
class TimestampsPartialUpdate(BaseApi):
    ...
    def timestamps_partial_update(
        ...
        return self._timestamps_partial_update_oapg(
            body=body,
