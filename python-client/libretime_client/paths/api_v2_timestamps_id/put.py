...
# body param
SchemaForRequestBodyApplicationJson = Timestamp
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Timestamp
SchemaForRequestBodyMultipartFormData = Timestamp


request_body_timestamp = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _timestamps_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_timestamp.serialize(body, content_type)
...
class TimestampsUpdate(BaseApi):
    ...
    def timestamps_update(
        ...
        return self._timestamps_update_oapg(
            body=body,
