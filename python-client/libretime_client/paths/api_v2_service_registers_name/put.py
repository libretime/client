...
# body param
SchemaForRequestBodyApplicationJson = ServiceRegister
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ServiceRegister
SchemaForRequestBodyMultipartFormData = ServiceRegister


request_body_service_register = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _service_registers_update_oapg(
        self,
    ...
    def _service_registers_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_service_register.serialize(body, content_type)
...
class ServiceRegistersUpdate(BaseApi):
    ...
    def service_registers_update(
        ...
        return self._service_registers_update_oapg(
            body=body,
