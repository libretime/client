...
# body param
SchemaForRequestBodyApplicationJson = PatchedWebstream
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedWebstream
SchemaForRequestBodyMultipartFormData = PatchedWebstream


request_body_patched_webstream = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Webstream
...
class BaseApi(api_client.Api):
    @typing.overload
    def _webstreams_partial_update_oapg(
        self,
    ...
    def _webstreams_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_webstream.serialize(body, content_type)
...
class WebstreamsPartialUpdate(BaseApi):
    ...
    def webstreams_partial_update(
        ...
        return self._webstreams_partial_update_oapg(
            body=body,
