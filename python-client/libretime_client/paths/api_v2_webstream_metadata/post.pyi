...
# body param
SchemaForRequestBodyApplicationJson = WebstreamMetadata
SchemaForRequestBodyApplicationXWwwFormUrlencoded = WebstreamMetadata
SchemaForRequestBodyMultipartFormData = WebstreamMetadata


request_body_webstream_metadata = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = WebstreamMetadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _webstream_metadata_create_oapg(
        self,
    ...
    def _webstream_metadata_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_webstream_metadata.serialize(body, content_type)
...
class WebstreamMetadataCreate(BaseApi):
    ...
    def webstream_metadata_create(
        ...
        return self._webstream_metadata_create_oapg(
            body=body,
