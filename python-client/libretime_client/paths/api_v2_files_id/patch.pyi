...
# body param
SchemaForRequestBodyApplicationJson = PatchedFile
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedFile
SchemaForRequestBodyMultipartFormData = PatchedFile


request_body_patched_file = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _files_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_file.serialize(body, content_type)
