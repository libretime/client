...
SchemaFor201ResponseBodyApplicationJson = ServiceRegister
...
class BaseApi(api_client.Api):
    @typing.overload
    def _service_registers_create_oapg(
        self,
...
class ServiceRegistersCreate(BaseApi):
    ...
    def service_registers_create(
        ...
        return self._service_registers_create_oapg(
            body=body,
