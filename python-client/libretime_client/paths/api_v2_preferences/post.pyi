...
SchemaForRequestBodyMultipartFormData = Preference
...
SchemaFor201ResponseBodyApplicationJson = Preference
...
class PreferencesCreate(BaseApi):
    ...
    def preferences_create(
        ...
        return self._preferences_create_oapg(
            body=body,
