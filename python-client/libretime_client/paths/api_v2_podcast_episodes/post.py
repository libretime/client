...
SchemaFor201ResponseBodyApplicationJson = PodcastEpisode
...
class BaseApi(api_client.Api):
    @typing.overload
    def _podcast_episodes_create_oapg(
        self,
...
class PodcastEpisodesCreate(BaseApi):
    ...
    def podcast_episodes_create(
        ...
        return self._podcast_episodes_create_oapg(
            body=body,
