...
# body param
SchemaForRequestBodyApplicationJson = MountName
SchemaForRequestBodyApplicationXWwwFormUrlencoded = MountName
SchemaForRequestBodyMultipartFormData = MountName


request_body_mount_name = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _mount_names_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_mount_name.serialize(body, content_type)
...
class MountNamesUpdate(BaseApi):
    ...
    def mount_names_update(
        ...
        return self._mount_names_update_oapg(
            body=body,
