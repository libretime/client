...
class BaseApi(api_client.Api):
    @typing.overload
    def _playout_history_template_fields_update_oapg(
        self,
...
class PlayoutHistoryTemplateFieldsUpdate(BaseApi):
    ...
    def playout_history_template_fields_update(
        ...
        return self._playout_history_template_fields_update_oapg(
            body=body,
