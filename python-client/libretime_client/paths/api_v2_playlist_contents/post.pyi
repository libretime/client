...
SchemaFor201ResponseBodyApplicationJson = PlaylistContent
...
class BaseApi(api_client.Api):
    @typing.overload
    def _playlist_contents_create_oapg(
        self,
...
class PlaylistContentsCreate(BaseApi):
    ...
    def playlist_contents_create(
        ...
        return self._playlist_contents_create_oapg(
            body=body,
