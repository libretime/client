...
# body param
SchemaForRequestBodyApplicationJson = Show
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Show
SchemaForRequestBodyMultipartFormData = Show


request_body_show = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Show
...
class BaseApi(api_client.Api):
    ...
    def _shows_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_show.serialize(body, content_type)
...
class ShowsCreate(BaseApi):
    ...
    def shows_create(
        ...
        return self._shows_create_oapg(
            body=body,
