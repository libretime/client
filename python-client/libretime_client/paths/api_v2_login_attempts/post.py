...
SchemaFor201ResponseBodyApplicationJson = LoginAttempt
...
class BaseApi(api_client.Api):
    @typing.overload
    def _login_attempts_create_oapg(
        self,
...
class LoginAttemptsCreate(BaseApi):
    ...
    def login_attempts_create(
        ...
        return self._login_attempts_create_oapg(
            body=body,
