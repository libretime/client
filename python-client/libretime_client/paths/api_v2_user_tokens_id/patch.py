...
# body param
SchemaForRequestBodyApplicationJson = PatchedUserToken
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedUserToken
SchemaForRequestBodyMultipartFormData = PatchedUserToken


request_body_patched_user_token = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UserToken
...
class BaseApi(api_client.Api):
    @typing.overload
    def _user_tokens_partial_update_oapg(
        self,
    ...
    def _user_tokens_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_user_token.serialize(body, content_type)
...
class UserTokensPartialUpdate(BaseApi):
    ...
    def user_tokens_partial_update(
        ...
        return self._user_tokens_partial_update_oapg(
            body=body,
