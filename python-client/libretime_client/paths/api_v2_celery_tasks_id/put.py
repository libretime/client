...
# body param
SchemaForRequestBodyApplicationJson = CeleryTask
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CeleryTask
SchemaForRequestBodyMultipartFormData = CeleryTask


request_body_celery_task = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _celery_tasks_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_celery_task.serialize(body, content_type)
...
class CeleryTasksUpdate(BaseApi):
    ...
    def celery_tasks_update(
        ...
        return self._celery_tasks_update_oapg(
            body=body,
