...
OverbookedSchema = schemas.BoolSchema
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['Schedule'], typing.List['Schedule']],
...
class BaseApi(api_client.Api):
    ...
    def _schedule_list_oapg(
        ...
        for parameter in (
            request_query_broadcasted,
            request_query_ends_after,
            request_query_ends_before,
            request_query_overbooked,
            request_query_position_status,
            request_query_starts_after,
            request_query_starts_before,
        ):
