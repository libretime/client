...
SchemaFor201ResponseBodyApplicationJson = ListenerCount
...
class BaseApi(api_client.Api):
    @typing.overload
    def _listener_counts_create_oapg(
        self,
...
class ListenerCountsCreate(BaseApi):
    ...
    def listener_counts_create(
        ...
        return self._listener_counts_create_oapg(
            body=body,
