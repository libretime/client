...
# body param
SchemaForRequestBodyApplicationJson = File
SchemaForRequestBodyApplicationXWwwFormUrlencoded = File
SchemaForRequestBodyMultipartFormData = File


request_body_file = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = File
...
class BaseApi(api_client.Api):
    ...
    def _files_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_file.serialize(body, content_type)
...
class FilesCreate(BaseApi):
    ...
    def files_create(
        ...
        return self._files_create_oapg(
            body=body,
