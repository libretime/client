...
# body param
SchemaForRequestBodyApplicationJson = PatchedLibrary
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedLibrary
SchemaForRequestBodyMultipartFormData = PatchedLibrary


request_body_patched_library = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Library
...
class BaseApi(api_client.Api):
    @typing.overload
    def _libraries_partial_update_oapg(
        self,
    ...
    def _libraries_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_library.serialize(body, content_type)
...
class LibrariesPartialUpdate(BaseApi):
    ...
    def libraries_partial_update(
        ...
        return self._libraries_partial_update_oapg(
            body=body,
