...
# body param
SchemaForRequestBodyApplicationJson = Library
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Library
SchemaForRequestBodyMultipartFormData = Library


request_body_library = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _libraries_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_library.serialize(body, content_type)
...
class LibrariesUpdate(BaseApi):
    ...
    def libraries_update(
        ...
        return self._libraries_update_oapg(
            body=body,
