...
# body param
SchemaForRequestBodyApplicationJson = Webstream
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Webstream
SchemaForRequestBodyMultipartFormData = Webstream


request_body_webstream = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Webstream
...
class BaseApi(api_client.Api):
    ...
    def _webstreams_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_webstream.serialize(body, content_type)
...
class WebstreamsCreate(BaseApi):
    ...
    def webstreams_create(
        ...
        return self._webstreams_create_oapg(
            body=body,
