...
# body param
SchemaForRequestBodyApplicationJson = SmartBlockCriteria
SchemaForRequestBodyApplicationXWwwFormUrlencoded = SmartBlockCriteria
SchemaForRequestBodyMultipartFormData = SmartBlockCriteria


request_body_smart_block_criteria = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = SmartBlockCriteria
...
class BaseApi(api_client.Api):
    @typing.overload
    def _smart_block_criteria_create_oapg(
        self,
    ...
    def _smart_block_criteria_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_smart_block_criteria.serialize(body, content_type)
...
class SmartBlockCriteriaCreate(BaseApi):
    ...
    def smart_block_criteria_create(
        ...
        return self._smart_block_criteria_create_oapg(
            body=body,
