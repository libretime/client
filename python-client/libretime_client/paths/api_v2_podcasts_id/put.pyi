...
# body param
SchemaForRequestBodyApplicationJson = Podcast
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Podcast
SchemaForRequestBodyMultipartFormData = Podcast


request_body_podcast = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _podcasts_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_podcast.serialize(body, content_type)
...
class PodcastsUpdate(BaseApi):
    ...
    def podcasts_update(
        ...
        return self._podcasts_update_oapg(
            body=body,
