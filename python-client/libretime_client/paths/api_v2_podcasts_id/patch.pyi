...
# body param
SchemaForRequestBodyApplicationJson = PatchedPodcast
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PatchedPodcast
SchemaForRequestBodyMultipartFormData = PatchedPodcast


request_body_patched_podcast = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Podcast
...
class BaseApi(api_client.Api):
    @typing.overload
    def _podcasts_partial_update_oapg(
        self,
    ...
    def _podcasts_partial_update_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_patched_podcast.serialize(body, content_type)
...
class PodcastsPartialUpdate(BaseApi):
    ...
    def podcasts_partial_update(
        ...
        return self._podcasts_partial_update_oapg(
            body=body,
