...
# body param
SchemaForRequestBodyApplicationJson = ShowInstance
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ShowInstance
SchemaForRequestBodyMultipartFormData = ShowInstance


request_body_show_instance = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShowInstance
...
class BaseApi(api_client.Api):
    @typing.overload
    def _show_instances_create_oapg(
        self,
    ...
    def _show_instances_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_show_instance.serialize(body, content_type)
...
class ShowInstancesCreate(BaseApi):
    ...
    def show_instances_create(
        ...
        return self._show_instances_create_oapg(
            body=body,
