...
# body param
SchemaForRequestBodyApplicationJson = LoginAttempt
SchemaForRequestBodyApplicationXWwwFormUrlencoded = LoginAttempt
SchemaForRequestBodyMultipartFormData = LoginAttempt


request_body_login_attempt = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _login_attempts_update_oapg(
        self,
    ...
    def _login_attempts_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_login_attempt.serialize(body, content_type)
...
class LoginAttemptsUpdate(BaseApi):
    ...
    def login_attempts_update(
        ...
        return self._login_attempts_update_oapg(
            body=body,
