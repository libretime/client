...
# body param
SchemaForRequestBodyApplicationJson = PlaylistContent
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PlaylistContent
SchemaForRequestBodyMultipartFormData = PlaylistContent


request_body_playlist_content = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _playlist_contents_update_oapg(
        self,
    ...
    def _playlist_contents_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_playlist_content.serialize(body, content_type)
...
class PlaylistContentsUpdate(BaseApi):
    ...
    def playlist_contents_update(
        ...
        return self._playlist_contents_update_oapg(
            body=body,
